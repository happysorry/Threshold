...
public class get_all_res implements Runnable {
    ...
    public get_all_res(double sim_time) {
    ...
    public int send_request(String con_name) {
        ...
        try {
            try {
                ...
                switch (con_name) {
                    case "app_mn1":
                        path = "http://192.168.99.123:666/~/mn-cse/mn-name/AE1/RFID_Container_for_stage0";
                        break;
                    case "app_mn2":
                        path = "http://192.168.99.123:777/~/mn-cse/mn-name/AE2/Control_Command_Container";
                        break;
                    case "app_mnae1":
                        path = "http://192.168.99.123:1111/test";
                        break;
                    case "app_mnae2":
                        path = "http://192.168.99.123:2222/test";
                }
